...
public class CustomDatePicker {
    ...
    private DatePickerView year_pv, month_pv, day_pv, hour_pv;
    ...
    private String currentMon, currentDay, currentHour; // 当前选中的月、日、时、分
    private boolean spanYear, spanMon, spanDay, spanHour, spanMin;
    private Calendar selectedCalender, startCalendar, endCalendar;
    private TextView tv_select, hour_text;

    public CustomDatePicker(Context context, String title, ResultHandler resultHandler, String startDate,
                            String endDate) {
