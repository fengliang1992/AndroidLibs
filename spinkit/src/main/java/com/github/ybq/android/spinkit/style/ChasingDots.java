...
public class ChasingDots extends SpriteContainer {
	...
	public ValueAnimator onCreateAnimation() {
		...
		return new SpriteAnimatorBuilder(this).rotate(fractions, 0, 360).duration(2000)
	...
	private class Dot extends CircleSprite {
		...
		public ValueAnimator onCreateAnimation() {
			...
			return new SpriteAnimatorBuilder(this).scale(fractions, 0f, 1f, 0f).duration(2000).easeInOut(fractions)
					.build();
		}
	}
