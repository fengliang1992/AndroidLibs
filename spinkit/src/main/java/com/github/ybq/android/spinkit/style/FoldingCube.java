...
public class FoldingCube extends SpriteContainer {
	...
	private class Cube extends RectSprite {
		...
		public ValueAnimator onCreateAnimation() {
			...
			return new SpriteAnimatorBuilder(this).alpha(fractions, 0, 0, 255, 255, 0, 0)
					.rotateX(fractions, -180, -180, 0, 0, 0, 0).rotateY(fractions, 0, 0, 0, 0, 180, 180).duration(2400)
