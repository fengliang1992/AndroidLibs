...
TEMPLATE_PREVIEW            创建一个适合于相机预览窗口的请求。<br>
TEMPLATE_STILL_CAPTURE      创建适用于静态图像捕获的请求。<br>
TEMPLATE_VIDEO_SNAPSHOT     在录制视频时创建适合静态图像捕获的请求。<br>
TEMPLATE_ZERO_SHUTTER_LAG   创建一个适合零快门延迟仍然捕获的请求。<br>
